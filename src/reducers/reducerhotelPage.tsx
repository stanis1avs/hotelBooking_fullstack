...
import {
  SendRoom, deleteRoom, createRoom, updateRoom,
  SendHotel, deleteHotel, createHotel, updateHotel,
  changeStateWithoutRequestType,
  recieveHotelPage } from './typesHotelRoom'
import { initStateForHotelPage } from './typesCommon'
...
export const {
  ...
  hotelPageFailure } = reducerhotelPage.actions;
