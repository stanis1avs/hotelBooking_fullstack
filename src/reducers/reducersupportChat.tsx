...
import { SendRequests, SendMessages, historyRequest, recieveSocketType, socketConnectType, sendDataWSType } from './typesSupportChat'
import { initStateForSupportChat } from './typesCommon'
...
export const {
  ...
  requestsSearchSuccess, messagesSearchSuccess, messageEvent, requestEvent, supportChatFailure } = reducersupportChat.actions;
